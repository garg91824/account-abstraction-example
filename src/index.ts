...
import { entrypoint } from "@biconomy/common";
 const mintNftPayERC20 = async () => {
  ...
  // Bundler off chain validation 
  // entrypoint.simulateValidation(userOp)
  // makes sure all entities adhere to 4337, this must be done before braodcasting the userOp and must be re run on every block
  // bundle userOps and execute handleOps 
